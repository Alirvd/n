                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @viptrt\
                                  \n\n--------بـدء تتبـع سجـل 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼--------\
                        ...
                        link = "[ 𝐀𝐋𝐈 𝐀𝐇𝐌𝐄𝐃(https://t.me/viptrt)"
                        text = (
                            "**✘ تقـريـر إشعـار 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼 ✘**\n\n"
