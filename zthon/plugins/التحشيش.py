...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/uwrwe) 🗑♻️𓆪\n**𓍹━─━─━─━─𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id == 6377763320 or user.id == 6377763320 or user.id == 6377763320:
...
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/uwrwe) 𓆪\n\n"
