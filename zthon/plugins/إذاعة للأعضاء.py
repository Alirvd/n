...
# =========================================================== #
#                           الملـــفـ كتـــابـــة مـــن الصفــــر - t.me/uwrwe                           #
# =========================================================== #
Warn = "hhh"
ZEDTHON_BEST_SOURCE = "[ᯓ 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼- اذاعـة خـاص 🚹](t.me/uwrwe) .\n\n**- جـارِ الاذاعـه خـاص لـ أعضـاء الكـروب 🛗\n- الرجـاء الانتظـار .. لحظـات ⏳**"
ZEDTHON_PRO_SOURCE = "[ᯓ 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼- اذاعـة زاجـل 🕊](t.me/uwrwe) .\n\n**- جـارِ الاذاعـه لـ قائمـة زاجـل 📜\n- الرجـاء الانتظـار .. لحظـات ⏳**"
ZELZAL_PRO_DEV = "[ᯓ 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼- اذاعـة زاجـل 🕊](t.me/uwrwe) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎉╎قائمـة الاذاعـه فـارغـه ؟! ❌**\n**⎉╎قم باضافـة يوزرات عبـر الامر**\n`.اضفـ زاجل` **بالـرد ع عدة يوزرات تفـصل بينهم مسـافـات**"
# =========================================================== #
    ...
    async for usr in event.client.iter_participants(event.chat_id):
        ...
        if zilzal.text:
            ...
            try:
                ...
                return
    ZELZAL_BEST_DEV = f"[ᯓ 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼- اذاعـة خـاص 🚹](t.me/uwrwe) .\n\n**⎉╎تمت الاذاعـه لـ اعضـاء الكـروب .. بنجـاح  ✅**\n**⎉╎عـدد {success} عضـو**"
    ...
    for user in users:
        ...
        if zilzal.text:
            ...
            try:
                ...
                zzz.edit(f"خطـأ فـي إرسـال الرسـالة إلــى {user_entity.id}: {str(e)}")
    ZELZAL_BEST_DEV = f"[ᯓ 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼- اذاعـة زاجـل 🕊](t.me/uwrwe) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎉╎تمت الاذاعـه .. بنجـاح  ✅**\n**⎉╎عـدد {success} أشخـاص**"
