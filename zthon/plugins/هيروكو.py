...
async def variable(var):  # sourcery no-metrics
    ...
    if exe == "get":
        ...
        if variable in heroku_var:
            await zed.edit("**⌔∮ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت الــمـــــ🪐ــجـــرة يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
        ...
        await zed.edit(f"**⌔∮** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بـوت الــمـــــ🪐ــجـــرة يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
...
async def dyno_usage(dyno):
    ...
    await asyncio.sleep(1.5)
    return await dyno.edit(
        "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼 - 𝑫𝒀𝑵𝑶 𝑼𝑺𝑨𝑮𝑬 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n\n"
        f"**⌔∮ اسم التطبيق في هيروكو :**\n"
        f"**    - معرف اشتراكك ⪼ {Config.HEROKU_APP_NAME}**"
        f"\n\n"
        f" **⌔∮ مدة اسـتخدامك لبوت الــمـــــ🪐ــجـــرة : **\n"
