...
ZelzalCoins_cmd = (
    "[ᯓ 𝘀𝗼𝘂𝗿𝗰𝗲  𝘼𝙇 -𝙈𝘼𝙅𝙍𝘼 - اوامـر تجميـع النقـاط](tmme/uwrwe) 𓆪\n\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**⪼ سيتم اضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. إذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @viptrt**"
)
